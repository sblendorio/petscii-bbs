...
160 PRINT " (YES OR NO)";
165 INPUT Q$ : IF Q$="." THEN GOSUB 10000 : GOTO 165
...
225 INPUT ZZ$: K=VAL(ZZ$) : IF ZZ$="." THEN GOSUB 10000 : GOTO 225
230 PRINT
235 IF K=0 THEN 280
240 IF K=1 THEN 250
245 GOTO 220
...
570 GOTO 670
575 PRINT
580 PRINT "T,P,A";:INPUT XY$ : IF XY$="." THEN GOSUB 10000 : GOTO 580
582 GOSUB 5000 : T1=X9 : F=Y9: P=Z9
590 F=F/100
...
1120 IF Z$="NO" OR Z$="." THEN 1130
1125 GOTO 1105
1130 PRINT
1135 PRINT "TOO BAD, THE SPACE PROGRAM HATES TO LOSE EXPERIENCED"
1140 PRINT "ASTRONAUTS.": PRINT: INPUT "PRESS ENTER TO QUIT"; ZZ$
1145 END
1150 PRINT
...
1180 INPUT ZZ$: B1=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000 : GOTO 1180
1185 Q$="NO"

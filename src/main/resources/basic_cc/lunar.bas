...
150 PRINT L,INT(A);INT(5280*(A-INT(A))),INT(3600*V),INT(M-N);TAB(41);
151 INPUT ZZ$: K=VAL(ZZ$) : IF ZZ$="." THEN GOSUB 10000 : GOTO 150
152 T=10
...
440 PRINT:PRINT:PRINT:INPUT "TRY AGAIN"; ZZ$
450 IF ZZ$="Y" OR ZZ$="S" THEN GOTO 70
9990 END

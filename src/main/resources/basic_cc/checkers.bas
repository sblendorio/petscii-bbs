...
65 PRINT:PRINT:INPUT "PRESS ENTER TO START"; ZZ$ : CLS
...
1230 CLS : PRINT "FROM ";MID$(STR$(R(1)),2);",";MID$(STR$(R(2)),2)" TO ";MID$(STR$(R(3)),2);",";MID$(STR$(R(4)),2);:R(0)=-99
...
1570 Z=0: T=0
1590 PROMPT$="FROM":GOSUB 2000:E=X9:H=Y9:X=E:Y=H:IF S(X,Y)<=0 THEN 1590
1670 PROMPT$="TO":GOSUB 2000:A=X9:B=Y9:X=A:Y=B
...
1802 PROMPT$="+TO":GOSUB 2100: A1=X9:B1=Y9:IF A1<0 THEN 1810
...
1999 END
2000 PRINT PROMPT$;"? ";:LINE INPUT XY$:IF XY$="" THEN 2000
...
2070 GOTO 2000
2100 PRINT PROMPT$;"? ";:LINE INPUT XY$:IF XY$="." THEN GOSUB 2200
2110 IF XY$="" THEN X9=-1:Y9=0:RETURN
2120 CP=INSTR(XY$,",")
2130 IF CP=0 OR CP=1 THEN X9=-1:Y9=0:RETURN

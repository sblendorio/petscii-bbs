...
800 PRINT "---------------------------------": PRINT
1000 INPUT "INSTRUCTIONS (Y OR N)",A$
...
3850 PRINT: INPUT "PRESS ENTER"; ZZ$
...
4700 PRINT TAB(4);"<APOLLO DIGBY ON-BOARD COMPUTER>": PRINT:Z4=Z4+1
4710 PRINT "SEC";TAB(6);"FEET";TAB(16);"SPEED";TAB(26);"FUEL"
4720 PRINT TAB(2);MID$(STR$(T),2);TAB(6);MID$(STR$(H),2);TAB(18);MID$(STR$(V),2);TAB(26);MID$(STR$(F),2)
4730 FOR I=1 TO 39
...
6730 FOR I=1 TO 40: IF I=(Y2+1) THEN PRINT "#";
...
8300 PRINT "CONDOLENCES WILL BE SENT TO YOUR NEXT OF KIN."

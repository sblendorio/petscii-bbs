...
459 PRINT:PRINT TAB(10); "S T A R   T R E K":SLEEP 1800
...
1200 END
1210 RETURN
1220 G=G*(INT(RND(1)*3)+1):PRINT "ROMULAN FIRES STRANGE WEAPON...":PRINT "CAUSES ";MID$(STR$(G),2);" IN DAMAGE": SLEEP 1800
1230 GOTO 1150
1250 REM WARP SPEED
...
3320 PRINT "*** KLINGON DESTROYED ***": SLEEP 1800
...
3430 PRINT "*** ROMULAN SHIP DESTROYED ***": SLEEP 1800
...
6100 PRINT:PRINT "     *****  TORPEDO MISSED *****": SLEEP 1800: PRINT:RETURN
6200 REM HIT STAR
...
6470 PRINT:PRINT "KLINGON DESTROYED": SLEEP 1800

...
150 DIM G(100),S(100)
160 A$="-\= * >!</=\-=-"
170 INPUT "WHAT IS YOUR NAME CAPTAIN",N$: IF N$="." THEN GOSUB 10000: GOTO 170
250 INPUT "SKILL LEVEL (1-5) 5 IS HARDEST",ZZ$: S=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000 : GOTO 250
...
459 PRINT:PRINT TAB(10); "S T A R   T R E K":SLEEP 1200
...
1000 REM PHASORS
1010 INPUT "ENTER SHIELD LEVEL",ZZ$: G=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000: GOTO 1010
1015 IF G<E7 THEN 1030
...
1200 END
1210 RETURN
1220 G=G*(INT(RND(1)*3)+1):PRINT "ROMULAN FIRES STRANGE WEAPON...":PRINT "CAUSES ";MID$(STR$(G),2);" IN DAMAGE": SLEEP 1200
1230 GOTO 1150
1250 REM WARP SPEED
1260 IF S1<=0 THEN 1290
1270 PRINT "CAN'T WARP WITH SHIELDS UP.":GOTO 1900
1290 INPUT "DIRECTION ",ZZ$: T1=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000: GOTO 1290
1295 IF T1<1 OR T1>8 THEN 1290
1300 INPUT "WARP SPEED",ZZ$: G=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000: GOTO 1300
1310 IF G*10 < E7 THEN 1360
...
2030 INPUT ZZ$: C2 = VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000: GOTO 2020
...
2398 PRINT "      4"
2399 RETURN 
2400 INPUT "DIRECTION (1-8)",ZZ$: D=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000:GOTO 2400
2410 IF D>0 AND D<9 THEN 2440
2420 PRINT "ANSWER BETWEEN 1 AND 8."
2430 GOTO 2400
2440 INPUT "IMPULSE SPEED",ZZ$: J=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000:GOTO 2440
...
3100 INPUT "AMOUNT OF ENERGY TO PHASORS",ZZ$: G=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000:GOTO 3100
...
3320 PRINT "*** KLINGON DESTROYED ***": SLEEP 1200
...
3430 PRINT "*** ROMULAN SHIP DESTROYED ***": SLEEP 1200
...
4500 INPUT "DIRECTION",ZZ$: D=VAL(ZZ$): IF ZZ$="." THEN GOSUB 10000:GOTO 4500
...
6100 PRINT:PRINT "     *****  TORPEDO MISSED *****": SLEEP 1200: PRINT:RETURN
6200 REM HIT STAR
...
6470 PRINT:PRINT "KLINGON DESTROYED": SLEEP 1200
...
7200 PRINT TAB(19);X:SLEEP 600:NEXT X

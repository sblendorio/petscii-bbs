...
30 PRINT "*";TAB(38);"*"
40 PRINT "*";TAB(38);"*"
50 PRINT "*";TAB(14);"STAR TREK";TAB(38);"*"
60 PRINT "*";TAB(38);"*"
70 PRINT "*";TAB(38);"*"
80 PRINT "*";TAB(12);"BY VINCE BRIEL";TAB(38);"*"
90 PRINT "*";TAB(38);"*"
100 PRINT "*";TAB(38);"*"
110 PRINT "*";TAB(38);"*"
120 PRINT "*";TAB(38);"*"
...
520 PRINT TAB(6); MID$(STR$(X1-1),2);"     ";MID$(STR$(X1),2);"     ";MID$(STR$(X1+1),2)
...
940 PRINT "   ";:GOTO 960
950 PRINT MID$(A$,S(C)*3+1,3);
960 NEXT X:PRINT:NEXT Y:FOR I=1 TO 30:PRINT "-";:NEXT I:PRINT:PRINT
970 PRINT "ENERGY=";MID$(STR$(E7),2);TAB(12);"SHIELDS=";MID$(STR$(S1),2);TAB(23);"TORP=";MID$(STR$(T),2):PRINT:PRINT:PRINT:PRINT:PRINT:RETURN
...
5000 PRINT TAB(9);MID$(STR$(X5),2);",";MID$(STR$(Y5),2): IF D<>1 THEN 5500
...
7200 PRINT TAB(18);X:FOR Y=1 TO 1000:NEXT Y:NEXT X

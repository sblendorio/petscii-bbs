...
public abstract class BbsThread extends Thread {
    ...
    public String readLineUppercaseMandatory() throws IOException {
        restartKeepAlive();
        final String result = io.readLineUppercaseMandatory();
        restartKeepAlive();
        return result;
    }
    ...
    public String readLineUppercase(Set<Integer> allowedChars) throws IOException {
        restartKeepAlive();
        final String result = io.readLineUppercase(allowedChars);
        restartKeepAlive();
        return result;
    }
    ...
    public byte[] resetInput() throws IOException { return io.resetInput(); }

    ...
    public void menuBasicPrograms() throws Exception {
        while (true) {
            ...
            do {
                ...
                else if ("4".equals(choice)) { SwBasicBridge.run("basic_cc/hamurabi.bas", this); subThread = null; }
                else if ("5".equals(choice)) { SwBasicBridge.run("basic_cc/checkers.bas", this); subThread = null; }

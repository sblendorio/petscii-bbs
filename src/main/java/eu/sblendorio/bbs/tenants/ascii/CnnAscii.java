...
public class CnnAscii extends RssAscii {
    ...
    public Map<String, Map<String, byte[]>> logos = ImmutableMap.of(
        "minitel", ImmutableMap.<String, byte[]> builder()
            .put("101", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Top Stories",13,10,10))
            .put("102", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"World",13,10,10))
            .put("103", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Africa",13,10,10))
            .put("104", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Americas",13,10,10))
            .put("105", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Asia",13,10,10))
            .put("106", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Europe",13,10,10))
            .put("107", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Middle East",13,10,10))
            .put("108", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"U.S.A.",13,10,10))
            .put("109", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Technology",13,10,10))
            .put("110", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Science & Space",13,10,10))
            .put("111", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Entertainment",13,10,10))
            .put("112", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Money",13,10,10))
            .put("113", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"World Sport",13,10,10))
            .put("114", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Football",13,10,10))
            .put("115", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Travel",13,10,10))
            .put("116", bytes(readBinaryFile("minitel/cnn_logo.vdt"), 30, 10,9,9,9,9,9,9,9,9,9,9,9,0x1b,0x47,"Most Recent",13,10,10))
            .build(),

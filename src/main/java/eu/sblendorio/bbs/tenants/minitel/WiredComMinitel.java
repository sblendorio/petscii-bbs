...
@Hidden
public class WiredComMinitel extends WordpressProxyAscii {
    ...
    private static final byte[] LOGO_BYTES =  bytes(readBinaryFile("minitel/wired.vdt"),30,10, 0x1b, 0x3a, 0x69, 0x43, 17);

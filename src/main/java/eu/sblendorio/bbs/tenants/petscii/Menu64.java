...
public class Menu64 extends PetsciiThread {
        ...
        while (true) {
            ...
            do {
                ...
                switch (key) {
                    ...
                    case '7' -> launch(new InternetBrowserNew());
                    case '*' -> launch(new InternetBrowser());
    ...
    public void menuBasicPrograms() throws Exception {
        do {
            ...
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'a', REVOFF, 161); println("Oregon Trail");
            ...
            do {
                ...
                switch (key) {
                    ...
                    case 'a' -> SwBasicBridge.run("Oregon Trail", "basic/oregon.bas", this, locate());

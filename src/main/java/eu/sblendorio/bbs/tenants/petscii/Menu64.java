...
public class Menu64 extends PetsciiThread {
    ...
    public void menuNewsEng() throws Exception {
        do {
            ...
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '1', REVOFF, 161); println("CNN - Full text");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '2', REVOFF, 161); println("CNN - Headlines");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '3', REVOFF, 161); println("BBC News");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '4', REVOFF, 161); println("Politico.com");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '5', REVOFF, 161); println("Al Jazeera");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '6', REVOFF, 161); println("Fox News");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '7', REVOFF, 161); println("Wired");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '8', REVOFF, 161); println("Vintage Computer Federation");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '9', REVOFF, 161); println("Indie Retro News");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '0', REVOFF, 161); println("The 8-Bit Guy");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'a', REVOFF, 161); println("Vintage is the new old");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'b', REVOFF, 161); println("2600 News");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'c', REVOFF, 161); println("Hackaday Blog");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'd', REVOFF, 161); println("Amedeo Valoroso - English");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, 'e', REVOFF, 161); println("NPR News");
            newline();
            ...
            do {
                ...
                log("Menu-NewsENG. Pressed: '" + (key < 32 || key > 127 ? "chr(" + key + ")" : ((char) key)) + "' (code=" +
                        key + ")");
                switch (key) {
                    case '1' -> launch(new LiteCnnPetscii());
                    case '2' -> launch(new CnnPetscii());
                    case '3' -> launch(new BbcPetscii());
                    case '4' -> launch(new OneRssPoliticoPetscii());
                    case '5' -> launch(new OneRssAJPlusPetscii());
                    case '6' -> launch(new OneRssFoxnewsPetscii());
                    case '7' -> launch(new WiredCom());
                    case '8' -> launch(new Vcfed());
                    case '9' -> launch(new IndieRetroNews());
                    case '0' -> launch(new The8BitGuy());
                    case 'a' -> launch(new Vitno());
                    case 'b' -> launch(new OneRss2600Petscii());
                    case 'c' -> launch(new HackadayPetscii());
                    case 'd' -> launch(new OneRssAmedeoValorosoEngPetscii());
                    case 'e' -> launch(new LiteNprPetscii());
                    case '.' -> { return; }
                    default -> validKey = false;
                }
                // if (validKey) return;
    ...
    public void menuBasicPrograms() throws Exception {
        do {
            ...
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '9', REVOFF, 161); println("Melissa (Systems - ITA)");
            write(RIGHT, RIGHT, RIGHT, ' ', GREY3, REVON, 161, '0', REVOFF, 161); println("Dobble");
            ...
            do {
                ...
                switch (key) {
                    ...
                    case '9' -> SwBasicBridge.run("Melissa", "basic/melissa.bas", this, locate());

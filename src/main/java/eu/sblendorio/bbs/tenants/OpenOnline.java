...
public class OpenOnline extends PetsciiThread {
    ...
    /*
    - Pagina Principale - https://www.open.online/rss.xml
    - Primo Piano - https://www.open.online/primo-piano/rss.xml
    - Il Mondo - https://www.open.online/mondo/rss.xml
    - Le Nostre Storie - https://www.open.online/inchieste/rss.xml
    - La Cronaca - https://www.open.online/cronaca/rss.xml
    - L'economia - https://www.open.online/economia-e-lavoro/rss.xml
    - Suoni e Visioni - https://www.open.online/arte-e-spettacolo/rss.xml
    Lo Sport - https://www.open.online/sport/rss.xml
    ...
    static Map<String, NewsSection> sections = new ImmutableMap.Builder<String, NewsSection>()
        .put("101", new NewsSection(WHITE, "Pagina Principale", PREFIX + "rss.xml", Logos.LOGO_ULTIMORA))
        .put("102", new NewsSection(CYAN, "Primo Piano", PREFIX + "primo-piano/rss.xml", Logos.LOGO_NOSTOP24H))
        .put("110", new NewsSection(RED, "Il Mondo", PREFIX + "mondo/rss.xml", Logos.LOGO_PRIMOPIANO))
        .put("120", new NewsSection(GREEN, "Le Nostre Storie", PREFIX + "inchieste/rss.xml", Logos.LOGO_POLITICA))
        .put("130", new NewsSection(BLUE, "La Cronaca", PREFIX + "cronaca/rss.xml", Logos.LOGO_ECONOMIA))
        .put("140", new NewsSection(GREY2, "L'economia", PREFIX + "economia-e-lavoro/rss.xml", Logos.LOGO_DALLITALIA))
        .put("150", new NewsSection(LIGHT_BLUE, "Suoni e Visioni", PREFIX + "arte-e-spettacolo/rss.xml", Logos.LOGO_DALMONDO))
        .put("160", new NewsSection(LIGHT_RED, "Lo Sport", PREFIX + "sport/rss.xml", Logos.LOGO_CULTURE))
        .build();
    ...
    public void doLoop() throws Exception {
        ...
        int pos = indexHtml.indexOf("class=\"top-categorie\"");
        String part = indexHtml.substring(pos);
        pos = indexHtml.indexOf("<");
        if (1==1) return;
    ...
    protected boolean displayText(String text, int screenRows, byte[] logo) throws Exception {
        cls();
        write(logo == null ? LOGO_OPEN : logo);
        write(GREY3);
